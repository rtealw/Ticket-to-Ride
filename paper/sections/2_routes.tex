...
The proportion of wins of the Hungry, Path, and One
Step Thinker strategies does not significantly
vary with $\alpha$.
The Hungry, Path, and One Step Thinker
strategies do not 

\end{multicols}
\begin{figure}
    \centering
    \includegraphics[scale=.69]{figures/points}
