...
A Destination Ticket's color indicates the difference
between its expected proportion of wins.
For example, the Destination Ticket New York/Seattle
(marked as 30) has value .09 because, on average,
players with New York/Seattle win $59\%$ of two-player
games and $34\%$ of four-player games.
