...
(Generally p-values below 1E-02 indicate
strong correlation.)

\end{multicols}
\begin{figure}[!h]
    \centering
    \includegraphics[scale=1]{figures/correlation_table}
    \caption{The Pearson p-value for linear relationships
    between effective resistance, minimum path length,
    proportion of two-player wins, proportion of four-player
    wins, and distance from the line of best fit.
    Darker gold indicates stronger correlation.}
...
\begin{figure}
    ...
    \begin{subfigure}[b]{\textwidth}
        ...
        of wins in four-player games and plotted by their effective
