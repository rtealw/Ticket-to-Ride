...
\cref{fig:resistance2}, and \cref{fig:resistance4}.

\begin{figure}[H]
    \centering
    \includegraphics[scale=.12]{figures/pearsons_table.png}
    \caption{The Pearson correlation statistic between
    proportion of wins in two- and four-player games
    and path length, resistance, and distance from
    the best fit line of \cref{fig:resistance2} and
    \cref{fig:resistance4}.
...
\begin{figure}
    \centering
    \includegraphics[scale=.6]{figures/resistance}
...
%        \includegraphics[scale=.75]{figures/resistance_two}
%        \caption{Destination Tickets colored by the proportion
%        of wins in two-player games and plotted by their effective
%        resistance and minimum path length.
%        The line of best fit gives an approximation of the
%        Destination Tickets that have a higher reward per effort
%        (above the line).
%        Note: the $9^{th}$ Destination Ticket 
%        is obscured by the $11^{th}$.}
...
%    \vfill
%    \begin{subfigure}[b]{\textwidth}
%        \includegraphics[scale=.75]{figures/resistance_four}
%        \caption{\cref{fig:resistance2} colored by proportion
%        of wins in four-player rather than two-player games.}
